...
void Panov::freeMemory(pair_t pairs, size_t size)
{
...
pair_t Panov::resize(pair_t old_pairs, size_t capacity)
{
  pair_t pairs = new std::pair< std::string, Panov::List< unsigned long long >* >[capacity + 10] {};
...
pair_t Panov::inputList(std::istream& in, size_t& size, size_t& max_size_list)
{
  size_t max_size = 0;
  std::string name = "";
  size_t capacity = 0;
